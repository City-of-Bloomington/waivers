...
<div class="tt-row-container">
	<dl class="fn1-output-field">
		...
		<dd><s:textfield name="waiver.waiverInstrumentNum" value="%{waiver.waiverInstrumentNum}" size="20" maxlength="20" required="true" />*
		</dd>
	</dl>

	<dl class="fn1-output-field">
		<dt>Recorded Date </dt>
		<dd><s:textfield name="waiver.recorderDate" value="%{waiver.recorderDate}" size="10" maxlength="10" class="date" required="true" />*
		</dd>
	</dl>
	<dl class="fn1-output-field">
		<dt>Waiver Book </dt>
