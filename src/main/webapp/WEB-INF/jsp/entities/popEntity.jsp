		...
		<s:form action="entity" id="form_id" method="post" >
			...
			<div class="tt-row-container">
				<dl class="fn1-output-field">
					<dt>Name </dt>
					<dd><s:textfield name="entity.name" value="%{entity.name}" size="30" maxlength="70" /> </dd>
				</dl>
				</dl>		
				<dl class="fn1-output-field">
					<dt>Title </dt>
					<dd><s:textfield name="entity.title" value="%{entity.title}" size="30" maxlength="30" />(Owner, Agent, Manager, etc) </dd>
				</dl>
				<dl class="fn1-output-field">
					<dt>Is Business? </dt>
