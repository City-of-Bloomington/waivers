    ...
    public void doPost(HttpServletRequest req, 
		...
		void writeCorporateAuthority(Document document,
				...
				try{
						...
						phrase = new Phrase();
						ch = new Chunk("My Commission Expires:____________ ",fnt);
						phrase.add(ch);
						cell = new RtfCell(phrase);
						cell.setBorder(Rectangle.NO_BORDER);
						table.addCell(cell);						
						...
						phrase = new Phrase();
						ch = new Chunk("Signed:_________________",fnt);
						phrase.add(ch);
						cell = new RtfCell(phrase);
						cell.setBorder(Rectangle.NO_BORDER);
						table.addCell(cell);
						...
						phrase = new Phrase();
						ch = new Chunk("Name Printed:__________________\n",fnt);
						phrase.add(ch);
		...
		void writeBusinessWaiver(Document document,
				...
				try{
						...
						//
						phrase = new Phrase();
						ch = new Chunk("Deed Instrument No.:",fntu);
						phrase.add(ch);
						cell = new RtfCell(phrase);
						cell.setBorder(0);
						table.addCell(cell);
						...
						//
						phrase = new Phrase();
						ch = new Chunk(businessEntity.getName()+"\n",fntu);
						phrase.add(ch);
						ch = new Chunk("By:\n\n",fnt);						
						document.add(phrase);
						//
						...
						phrase.add(ch);						
						ch = new Chunk("Name Printed:"+agent.getName()+"\n",fnt);
						phrase.add(ch);
						ch = new Chunk("Title:"+agent.getTitle()+"\n\n",fnt);
						phrase.add(ch);						
						document.add(phrase);
						//
						table = new Table(2);
						...
						//
						phrase = new Phrase();
						ch = new Chunk("Before me, a Notary Public, personally appeared "+agent.getName()+" and acknowledged the execution of the above release of the right to remonstrate against pending or future annexation to the City of Bloomington, Indiana, to be his voluntary act and deed, this ____ day of ____________, 20____. \n\n",fnt);
						phrase.add(ch);
						pp = new Paragraph();
						pp.setIndentationLeft(20);
						pp.setFirstLineIndent(pp_indent);
