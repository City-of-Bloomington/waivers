...
public class EmailHandle{
    ...
    static String from = "sibow@bloomington.in.gov";
		static String host = "smtp.bloomington.in.gov"; // whoville.city. ...
		// static String host = "localhost"; 
    static boolean debug = true;
    static String subject = "Waiver service address go ahead notification";
    static String _subject = "Waiver";
    static String _msgText = "This is a message body.\nHere's the second line.";
    static String _to = "sibow@bloomington.in.gov";
    static String _from = "sibow@bloomington.in.gov";
    ...
    public static void main(String[] args) {
				...
				if (args.length > 0 && args.length != 5) {
						...
						from = args[1];
						host = args[2];
						debug = Boolean.valueOf(args[3]).booleanValue();
						msgText = args[4];
						EmailHandle mm = new EmailHandle();
						mm.send();
				}
     ...
     */
    public EmailHandle(){
				this(_to,_from, null, null,_subject, _msgText, _debug);
    }
    public EmailHandle( String to2,
												String from2,
												String cc2,
